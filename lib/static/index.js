                  ...
                  while (1) {
                    switch (_context8.prev = _context8.next) {
                      ...
                      case 26:
                        ...
                        routeInfoFilename = _path2.default.join(config.paths.DIST, route.path, 'routeInfo.' + process.env.REACT_STATIC_BUILD_HASH + '.json');
                        _context8.next = 34;
...
(function () {
  ...
  reactHotLoader.register(fetchSiteData, 'fetchSiteData', 'src/static/index.js');
  reactHotLoader.register(exportSharedRouteData, 'exportSharedRouteData', 'src/static/index.js');
  reactHotLoader.register(fetchRoutes, 'fetchRoutes', 'src/static/index.js');
  reactHotLoader.register(buildHTML, 'buildHTML', 'src/static/index.js');
