...
exports.exportRoutes = exports.prepareRoutes = exports.buildXMLandRSS = undefined;
          ...
          case 29:
            ...
            return (0, _shared.poolAll)(config.routes.map(function (route) {
              return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
                var sharedPropsHashes, templateID, localProps, allProps, routePath, routeInfo, embeddedRouteInfo, InitialPropsContext, renderMeta, chunkNames, head, clientScripts, clientStyleSheets, clientCss, ClientCssHash, FinalComp, renderToStringAndExtract, appHtml, HtmlWithMeta, HeadWithMeta, BodyWithMeta, DocumentHtml, html, htmlFilename, routeInfoFilename, res;
