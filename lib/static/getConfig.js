...
var recurseCreateNormalizedRoute = function recurseCreateNormalizedRoute() {
  ...
  if (config.tree) {
    return routes.map(function (route) {
      ...
      normalizedRoute.children = recurseCreateNormalizedRoute(normalizedRoute.children, normalizedRoute, config);
      return normalizedRoute;
    }).filter(function (d) {
      return d !== null;
    });
  ...
  return routes.reduce(function () {
    ...
    var normalizedRoute = createNormalizedRoute(route, parent, config);
    var routeExists = memo.find(function (_ref) {
      var path = _ref.path;
      return path === normalizedRoute.path;
    });

    return [].concat(_toConsumableArray(memo), _toConsumableArray(recurseCreateNormalizedRoute(route.children, normalizedRoute, config)), _toConsumableArray(routeExists ? [] : [normalizedRoute]));
  }, []);
};
...
(function () {
  ...
  reactHotLoader.register(REGEX_TO_CUT_TO_ROOT, 'REGEX_TO_CUT_TO_ROOT', 'src/static/getConfig.js');
  reactHotLoader.register(REGEX_TO_REMOVE_TRAILING_SLASH, 'REGEX_TO_REMOVE_TRAILING_SLASH', 'src/static/getConfig.js');
  reactHotLoader.register(REGEX_TO_REMOVE_LEADING_SLASH, 'REGEX_TO_REMOVE_LEADING_SLASH', 'src/static/getConfig.js');
  reactHotLoader.register(DEFAULT_NAME_FOR_STATIC_CONFIG_FILE, 'DEFAULT_NAME_FOR_STATIC_CONFIG_FILE', 'src/static/getConfig.js');
  reactHotLoader.register(DEFAULT_PATH_FOR_STATIC_CONFIG, 'DEFAULT_PATH_FOR_STATIC_CONFIG', 'src/static/getConfig.js');
  reactHotLoader.register(DEFAULT_ROUTES, 'DEFAULT_ROUTES', 'src/static/getConfig.js');
  reactHotLoader.register(DEFAULT_ENTRY, 'DEFAULT_ENTRY', 'src/static/getConfig.js');
  reactHotLoader.register(PATH_404, 'PATH_404', 'src/static/getConfig.js');
  reactHotLoader.register(cutPathToRoot, 'cutPathToRoot', 'src/static/getConfig.js');
  reactHotLoader.register(trimLeadingAndTrailingSlashes, 'trimLeadingAndTrailingSlashes', 'src/static/getConfig.js');
  reactHotLoader.register(throwErrorIfRouteIsMissingPath, 'throwErrorIfRouteIsMissingPath', 'src/static/getConfig.js');
  reactHotLoader.register(consoleWarningForRouteWithoutNoIndex, 'consoleWarningForRouteWithoutNoIndex', 'src/static/getConfig.js');
  reactHotLoader.register(createNormalizedRoute, 'createNormalizedRoute', 'src/static/getConfig.js');
  reactHotLoader.register(consoleWarningForMutlipleRoutesWithTheSamePath, 'consoleWarningForMutlipleRoutesWithTheSamePath', 'src/static/getConfig.js');
  reactHotLoader.register(recurseCreateNormalizedRoute, 'recurseCreateNormalizedRoute', 'src/static/getConfig.js');
  reactHotLoader.register(normalizeRoutes, 'normalizeRoutes', 'src/static/getConfig.js');
  reactHotLoader.register(makeGetRoutes, 'makeGetRoutes', 'src/static/getConfig.js');
  reactHotLoader.register(buildConfigation, 'buildConfigation', 'src/static/getConfig.js');
  reactHotLoader.register(buildConfigFromPath, 'buildConfigFromPath', 'src/static/getConfig.js');
  reactHotLoader.register(fromFile, 'fromFile', 'src/static/getConfig.js');
