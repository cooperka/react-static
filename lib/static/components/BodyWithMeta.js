...
(function () {
  ...
  reactHotLoader.register(REGEX_FOR_SCRIPT, 'REGEX_FOR_SCRIPT', 'src/static/components/BodyWithMeta.js');
  reactHotLoader.register(generateRouteInformation, 'generateRouteInformation', 'src/static/components/BodyWithMeta.js');
  reactHotLoader.register(makeBodyWithMeta, 'makeBodyWithMeta', 'src/static/components/BodyWithMeta.js');
  leaveModule(module);
})();
