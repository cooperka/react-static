...
(function () {
  ...
  reactHotLoader.register(REGEX_TO_GET_LAST_SLASH, 'REGEX_TO_GET_LAST_SLASH', 'src/static/buildXML.js');
  reactHotLoader.register(getPermaLink, 'getPermaLink', 'src/static/buildXML.js');
  reactHotLoader.register(makeGenerateRouteXML, 'makeGenerateRouteXML', 'src/static/buildXML.js');
  reactHotLoader.register(generateXML, 'generateXML', 'src/static/buildXML.js');
  reactHotLoader.register(getSiteRoot, 'getSiteRoot', 'src/static/buildXML.js');
  reactHotLoader.register(_default, 'default', 'src/static/buildXML.js');
  leaveModule(module);
})();
